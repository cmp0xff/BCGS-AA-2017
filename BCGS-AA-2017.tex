...
\institute[Uni zu Köln, Uni Bonn] % (optional, but mostly needed)
{
  %\inst{1}%
...
{./logos/BCGS/bcgs_logo_vektorgrafikNeu}
...
defernumbers=true]%
	{biblatex}
\addbibresource{pre-pure-mixed.bib}
...
Dilaton Gravity Model}{\cite{Callan1992,Demers1996,Ashtekar2011}}% 1/2}
...
\begin{frame}{More on Trace Distance \cite[ch.~9]{Wilde2009}}{Interpretation}
\begin{itemize}
